...
#  Init user object
venkat = User('venkat Bvs', 'venkat@gmail.com', 37)
...
venkat.has_birthday()
print(venkat.greeting())

#Encapsulation -->
venkat.print_encap()
venkat._private = 800 #Changing for venkat
venkat.print_encap()

# Method inherited from parent
janet.print_encap() #Changing the variable for venkat doesn't affect janets variable --> Encapsulation
janet._private = 600
janet.print_encap()

#Similary changing janet's doesn't affect venkat's variable.
venkat.print_encap()
